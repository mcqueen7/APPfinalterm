    ...
    <>
      ...
      <Actionsheet isOpen={isOpen} onClose={onClose}>
        <Actionsheet.Content>
          ...
          <Actionsheet.Item onPress={()=>{dispatch(setArtCounter(artcount + 1)) }}><HStack alignItems={"center"} ><MaterialCommunityIcons name="file-outline" color={iconColor} size={20} /><Text fontSize={16} ml={3}>開啟新檔</Text></HStack></Actionsheet.Item>
          ...
          <Actionsheet.Item onPress={()=>{dispatch(setArtCounter(artcount - 1)) }}><HStack alignItems={"center"}><MaterialCommunityIcons name="delete" color={iconColor} size={20} /><Text fontSize={16} ml={3}>刪除貼文</Text></HStack></Actionsheet.Item>
